        ...
        <div class="row">
            ...
            <div class=" d-none" id="services">
                @foreach ($categories as $category)
                    ...
                    <x-product_and_services :products="$products" :services="$services" :for="$for" :categoryId="$categoryId" />
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body ">
                            <div class="row">
                                ...
                                <div class=" col-3">
                                    @livewire('text-component', ['expiry', 'Expiry'])
                                </div>
