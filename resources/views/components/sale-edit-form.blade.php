<div>
       <form action="{{ route('sale_update') }}" method="POST" class="form-validation pt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-3">
                                        @livewire('text-component-edit', [$sale, 'f_name', 'Firts Name'])
                                    </div>
                                    <div class=" col-3">
                                    ...
                                    <script>
                                        ...
                                        function updateFieldsValidation() {
                                            ...
                                            if (selectedValue === 'Run Credit Check' || selectedValue === 'call back' || selectedValue === 'Credit Check Done' || selectedValue === 'Active account') {
                                    ...
                                    <div class="row d-none" id="services">
                                        @php
                                        ...
                                        @foreach ($categories as $category)
                                            ...
                                            @endphp
                                            <x-product_and_services_edit :products="$products" :services="$services"
                                                                         :for="$for" :categoryId="$categoryId" :sale="$sale" />
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body ">
                                                    <div class="row">
                                                        ...
                                                        <div class=" col-3">
                                                            @livewire('text-component-edit', [$sale, 'xp', 'XP'])
                                                        </div>
                                                ...
                                                <div class="modal-footer">
                                                    @can('sale.update')
                                                        <button type="submit"
                                                            class="bg-primary rounded text-white border-0 p-2">Edit Sale</button>
                                                    @endcan
                                                </div>
                                            </div>
                                        </div>
